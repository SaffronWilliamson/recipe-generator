...
public class UserInputHandler {
    ...
    public Recipe generateRecipe(String[] preferences) {
        ...
        if (veg.equalsIgnoreCase("yes") && spicy.equalsIgnoreCase("yes") && lowCal.equalsIgnoreCase("yes")) {
            return new Recipe("Spicy, Veg Stir-fry",
                    2,
                    2,
                    350,
                    20,
            ...
            return new Recipe("Fiery Chickpea & Veg Curry",
                    3,
                    3,
                    600,
                    40,
            ...
            return new Recipe("Light Veggie Quinoa Bowl",
                    0,
                    2,
                    280,
                    25,
            ...
            return new Recipe("Creamy Mushroom & Spinach Pasta",
                    0,
                    4,
                    800,
                    30,
            ...
            return new Recipe("Spicy Grilled Chicken Salad",
                    2,
                    2,
                    320,
                    25,
            ...
            return new Recipe("Fiery Beef & Pepper Stir-Fry",
                    3,
                    3,
                    750,
                    30,
            ...
            return new Recipe("Lemon Herb Baked Fish",
                    0,
                    2,
                    250,
                    20,
            ...
            return new Recipe("Creamy Garlic Butter Chicken",
                    0,
                    4,
                    900,
                    35,
